...
## LEDs
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports {internal_led[0]}]
set_property -dict {PACKAGE_PIN C16 IOSTANDARD LVCMOS33} [get_ports {internal_led[1]}]

set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS33} [get_ports internal_led0_b]
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33} [get_ports internal_led0_g]
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports internal_led0_r]
...
set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS33} [get_ports {external_led[0]}]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { external_led[1] }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports {external_led[2]}]
set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports {external_led[3]}]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports {external_led[4]}]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { external_led[5] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports {external_led[6]}]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { external_led[7] }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports {external_led[8]}]

set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { spi_tft_miso }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { spi_tft_clk }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { i2c_sda }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { spi_tft_mosi }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { i2c_scl }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVDS_25} [get_ports { trig_in_n[7] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVDS_25 } [get_ports { gpio_clk_p }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVDS_25 } [get_ports { gpio_clk_n }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVDS_25 } [get_ports { trig_in_p[7]  }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVDS_25 } [get_ports { trig_in_n[6]  }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVDS_25 } [get_ports { trig_in_p[6]  }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { spi_tft_csn }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
set_property -dict {PACKAGE_PIN R3 IOSTANDARD LVCMOS33} [get_ports {trig_out[0]}]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports {trig_out[1]}]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVDS_25} [get_ports {trig_in_p[0]}]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports { spi_card_csn }]; #IO_L3P_T0_DQS_34 Sch=pio[29]
set_property -dict {PACKAGE_PIN T2 IOSTANDARD LVDS_25} [get_ports {trig_in_n[0]}]
#set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports { pio[31] }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVDS_25} [get_ports {trig_in_n[1]}]
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVDS_25} [get_ports {trig_in_p[1]}]
set_property -dict { PACKAGE_PIN W3    IOSTANDARD LVCMOS33 } [get_ports { rst }]; #IO_L6N_T0_VREF_34 Sch=pio[34]
...
set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVDS_25} [get_ports {trig_in_n[2]}]
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVDS_25} [get_ports {trig_in_p[2]}]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVDS_25 } [get_ports { trig_in_n[5] }]; #IO_L16N_T2_34 Sch=pio[39]
set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports { tft_irq }]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVDS_25 } [get_ports { trig_in_p[5] }]; #IO_L16P_T2_34 Sch=pio[41]
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVDS_25} [get_ports {trig_in_n[3]}]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVDS_25} [get_ports {trig_in_n[4]}]
set_property -dict {PACKAGE_PIN U3 IOSTANDARD LVDS_25} [get_ports {trig_in_p[3]}]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { tft_sda }]; #IO_L19P_T3_34 Sch=pio[45]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVDS_25} [get_ports {trig_in_p[4]}]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { tft_scl}]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
...
set_property BITSTREAM.CONFIG.USERID 32'hDEADBEEF [current_design]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {s_stretched_pulses[0]} {s_stretched_pulses[1]} {s_stretched_pulses[2]} {s_stretched_pulses[3]} {s_stretched_pulses[4]}]]
connect_debug_port u_ila_0/probe1 [get_nets [list {data_out[0]} {data_out[1]} {data_out[2]} {data_out[3]} {data_out[4]}]]

connect_debug_port u_ila_0/probe0 [get_nets [list {s_registered_data[0]} {s_registered_data[1]} {s_registered_data[2]} {s_registered_data[3]}]]
connect_debug_port u_ila_0/probe2 [get_nets [list I2/coincidence_out0_n_0]]
